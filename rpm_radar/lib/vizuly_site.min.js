...
var keysLength = keys.length,
    selectedTeams = [29],
    teamNames = ['MIL', 'GSW', 'BOS', 'TOR', 'UTA', 'DEN', 'PHI', 'IND', 'OKC', 'HOU', 'POR', 'NOP', 'SAS', 'MIN', 'DAL', 'LAL', 'CHO', 'LAC', 'MEM', 'MIA', 'SAC', 'BRK', 'WAS', 'ORL', 'DET', 'PHO', 'ATL', 'NYK', 'CHI', 'CLE'],
    TABLE_HEADERS = ['Name'];
...
function initialize() {
    viz = vizuly.viz.corona(document.getElementById("viz_container")), viz.data(data).margin({
        ...
        viz_title = viz.selection().select("svg").append("text").attr("class", "title").attr("y", 40).attr("text-anchor", "middle").text("2019-19 赛季 RPM 阵容深度（时间加权）"),
